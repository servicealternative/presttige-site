...
LAMBDA_NAME="presttige-founder-admin"
LAMBDA_DIR="$ROOT/backend/founder-admin"
...
cp "$ROOT/backend/lib/founder_inviter_eligibility.py" "$BUILD_DIR/founder_inviter_eligibility.py"
